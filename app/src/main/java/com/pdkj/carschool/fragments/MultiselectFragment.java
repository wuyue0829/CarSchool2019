...
import com.pdkj.carschool.databinding.FragMultiselectBinding;
import com.pdkj.carschool.utils.StringUtil;
import com.pdkj.carschool.widgets.MyImageSpan;
...
public class MultiselectFragment extends BaseFragment<FragMultiselectBinding> {
    ...
    private LinearLayout lvn_mult_item4;
...
//    }
    ...
    protected void init() {
        ...
        if(!TextUtils.isEmpty(bean.getItem4())){
            ...
            lvn_mult_item4.setVisibility(View.INVISIBLE);
        }
    ...
    private void showErrorSubject(String myAnswer) {
        ...
        StringBuilder builder = new StringBuilder("我的答案: ");
