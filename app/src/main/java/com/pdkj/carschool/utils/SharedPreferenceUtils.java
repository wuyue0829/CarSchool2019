...
public class SharedPreferenceUtils {
    ...
    public static String getStringValue (Context context, String paramsName,String defValue) {
        SharedPreferences preferences = context.getSharedPreferences (PROPERTIES_FILE, Context.MODE_PRIVATE);
        String value = null;
        if (preferences.contains (paramsName)) {
            value = preferences.getString (paramsName, defValue);
        }
        return value;
    }
    ...
    public static boolean getBooleanValue (Context context, String paramsName) {
        ...
        if (preferences.contains (paramsName)) {
            value = preferences.getBoolean (paramsName, false);
        }
        return value;
    }
